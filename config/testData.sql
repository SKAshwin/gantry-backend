...
INSERT into event(name, url, ID, timetags) VALUES
    ('Data Science CoP','cop2018', '2c59b54d-3422-4bdb-824c-4125775b44c8', '[{"label":"release","time":"2019-04-12T09:00:00Z"}]'),
	('SDB Cohesion','sdbcohesionnovember', '3820a980-a207-4738-b82b-45808fe7aba8', '[{"label":"release","time":"2019-10-08T12:00:00Z"},{"label":"formrelease","time":"2019-10-08T16:30:12Z"}]'),
	('CSSCOM Planning Seminar','csscom', '03293b3b-df83-407e-b836-fb7d4a3c4966', '[]'),
    ('Supply Rally','supply','c14a592c-950d-44ba-b173-bbb9e4f5c8b4', '[{"label":"testlabel","time":"2019-06-08T20:30:00Z"}]');
